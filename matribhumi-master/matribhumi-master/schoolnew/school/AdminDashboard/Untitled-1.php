                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form action="db/edit.php" method="post">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="studentName" type="text" class="form-control" id="studentName" value="<?php echo $studentName; ?>">
                      </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                      <label for="weight" class="col-md-4 col-lg-3 col-form-label">Student Weight</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="weight" type="text" class="form-control" id="weight" value="<?php echo $weight; ?>">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="height" class="col-md-4 col-lg-3 col-form-label">Student Height</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="height" type="text" class="form-control" id="height" value="<?php echo $height; ?>">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="homeAddress" class="col-md-4 col-lg-3 col-form-label">Student Address</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="homeAddress" type="text" class="form-control" id="homeAddress" value="<?php echo $homeAddress; ?>">
                      </div>
                    </div>
