															...
															<div class="woocommerce">
																...
																<div class="col-md-6 offset-md-3" id="formid">
																	<div class="my-card mt-5 radius">
																		<div class="container">
																			<img style="width: 60px; margin-left: 20%;" src="assets/img/key.png" alt="" />
																		</div>
																		<h3 class="text-center">Parent Login here...</h3>
																		<form class="formId" action="parentlogin.php" method="post">
																			<div class="form-group">
																				<label for="email">Username</label>
																				<input type="text" required name="userId" class="form-control" id="userId" aria-describedby="emailHelp" placeholder="Enter Your UserId...">
																			</div>
																			<div class="form-group">
																				<label for="password">Password</label>
																				<input type="password" class="form-control" required name="pass" id="password" aria-describedby="emailHelp" placeholder="Enter Your password...">
																			</div>
																			<div class="container">
