...
<body style="background-image: url('user_assets/img/banner4.jpg'); background-size:cover; background-repeat:no-repeat;">
	...
	?>
		...
		<div class="result-box custom-box hide">
			<h1 style="font-family:URW Chancery L, cursive; font-weight:900;  color:seagreen">Quiz Result</h1>
			<div class="row">

			</div>
			<table style="border-radius: 2px;  font-family: URW Chancery L, cursive; font-weight:900;">
				<tr>
					<td style="color:crimson;">Total Question </td>
					<td><span class="total-question res"></span> </td>
				</tr>
				<tr>
					<td style="color:darkorange;">Attempt </td>
					<td><span class="total-attempt res"></span> </td>
				</tr>
				<tr>
					<td style="color:green;">Correct </td>
					<td><span class="total-correct res"></span> </td>
				</tr>
				<tr>
					<td style="color:red;" >Wrong </td>
					<td><span class="total-wrong res"></span> </td>
				</tr>
				<tr>
					<td style="color:darkturquoise;">Percentage </td>
					<td><span class="percentage res"></span> </td>
				</tr>
				<tr>
					<td style="color:hotpink;">Your Total Score </td>
					<td><span class="total-score res"></span> </td>
				</tr>
			</table>
			...
			<button type="button" class="btn" style="background-color:yellowgreen;">
			<a href="veiwSolution.php" style="color:white; text-decoration:none;">Quiz Solution</a></button>
