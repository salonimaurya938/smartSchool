...
! function(e, t, n) {
    ...
    function v(e, t, n, o, i) {
        ...
        return r(t, "string") || r(t, "undefined") ? g(s, t, o, i) : (s = (e + " " + _.join(a + " ") + a).split(" "), c(s, t, n))
    }
    ...
    E.prefixed = function(e, t, n) {
        return 0 === e.indexOf("@") ? j(e) : (-1 != e.indexOf("-") && (e = a(e)), t ? v(e, t, n) : v(e, "pfx"))
    };
    E.testAllProps = y, Modernizr.addTest("csstransitions", y("transition", "all", !0)), o(), i(C), delete E.addTest, delete E.addAsyncTest;
