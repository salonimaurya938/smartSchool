    ...
    var dtBlogPostsWidgetHandler = function($scope, $) {
        ...
        $(window).on('load', function() {
            ...
            if ($('.tpl-blog-holder.apply-equal-height').length) {
                $(".tpl-blog-holder.apply-equal-height article").matchHeight({
                    property: "min-height"
                })
            }
        });
            ...
            if ($b.length) {
                ...
                $(document).on('click', '.loadmore-btn.more-items', function() {
                    ...
                    $.ajax({
                        ...
                        url: dttheme_urls.ajaxurl,
                        data: {
                            action: "pallikoodam_ajax_load_more_post",
                            count: $count,
                            cats: $cats,
                            pos: $pos,
                            style: $style,
    ...
    var dtBlogRelatedPostsWidgetHandler = function($scope, $) {
        ...
        if ($(".dt-sc-related-posts.dt-related-carousel").length) {
            $(".dt-sc-related-posts.dt-related-carousel").each(function() {
                ...
                if ($(window).width() <= 767 || $('#primary').width() <= 570) {
                    $min = 1;
                }

                var prv = $(this).find('.prev-arrow');
                var nxt = $(this).find('.next-arrow');
