...
function(t, e, n) {
    ...
    var o = {
        ...
        tabsInit: function(e) {
            var n, a = t(".jet-tabs", e).first(),
                ...
                g = !!h && h.replace("#", "").split("&");
            if ("click" === l.event ? s.on("click.jetTabs", function() {
                    var e = t(this),
                        n = +e.data("tab") - 1,
            ...
            function w(t) {
                ...
                }), s.removeClass("active-tab"), n.addClass("active-tab"), s.attr("aria-expanded", "false"), n.attr("aria-expanded", "true"), d.removeClass("active-content"), r = o.outerHeight(!0), r += parseInt(c.css("border-top-width")) + parseInt(c.css("border-bottom-width")), o.addClass("active-content"), d.attr("aria-hidden", "true"), o.attr("aria-hidden", "false"), c.css({
                    height: r
            ...
            function v(e) {
                ...
                n.data("template-loaded", !0), t.ajax({
                    ...
                    success: function(t, e, a) {
                        ...
                        Promise.all(o.addedAssetsPromises).then(function(t) {
            ...
            l.ajaxTemplate && v(l.activeIndex), t(window).on("resize.jetTabs orientationchange.jetTabs", function() {
                c.css({
                    height: "auto"
                })
            }), g && s.each(function(e) {
        ...
        switcherInit: function(e) {
            var n, o = t(".jet-switcher", e).first(),
                ...
                s = t("> .jet-switcher__control-instance > .jet-switcher__control, > .jet-switcher__control", i),
                d = t("> .jet-switcher__content", r),
                l = (t("> .jet-switcher__content--disable", r), t("> .jet-switcher__content--enable", r), o.hasClass("jet-switcher--disable"));
            o.data("settings");
            ...
            function u(t) {
                ...
                }), o.toggleClass("jet-switcher--disable jet-switcher--enable"), e = (l = !o.hasClass("jet-switcher--disable")) ? s.eq(1) : s.eq(0), n = l ? d.eq(1) : d.eq(0), d.removeClass("active-content"), c = n.outerHeight(!0), c += parseInt(r.css("border-top-width")) + parseInt(r.css("border-bottom-width")), n.addClass("active-content"), s.attr("aria-expanded", "false"), e.attr("aria-expanded", "true"), d.attr("aria-hidden", "true"), n.attr("aria-hidden", "false"), r.css({
                    height: c
        ...
        accordionInit: function(e) {
            var n, a, i = t(".jet-accordion", e).first(),
                ...
                c = t("> .jet-accordion__inner > .jet-toggle > .jet-toggle__control", i),
                s = i.data("settings"),
            ...
            t(window).on("resize.jetAccordion orientationchange.jetAccordion", function() {
                ...
                var e = t(this),
                    ...
                    c = +e.data("toggle") - 1;
                if (s.collapsible) o.hasClass("active-toggle") || d.each(function(e) {
                    var o = t(this),
                        d = t("> .jet-toggle__control", o),
                        l = t("> .jet-toggle__content", o),
                        u = t("> .jet-toggle__content > .jet-toggle__content-inner", o).outerHeight();
                    u += parseInt(l.css("border-top-width")) + parseInt(l.css("border-bottom-width")), e === c ? (o.addClass("active-toggle"), l.css({
                        height: u
                    }), d.attr("aria-expanded", "true"), l.attr("aria-hidden", "false"), s.ajaxTemplate && h(c), r.trigger("jet-tabs/accordion/show-toggle-event/before", {
                        target: i,
                        toggleIndex: c
                    ...
                    }), o.removeClass("active-toggle"), d.attr("aria-expanded", "false"), l.attr("aria-hidden", "true"), a && clearTimeout(a), a = setTimeout(function() {
                        l.css({
                            height: 0
                        })
                    }, 5))
                    ...
                    var l = t("> .jet-toggle__content", o),
                        u = t("> .jet-toggle__content > .jet-toggle__content-inner", o).outerHeight();
                    u += parseInt(l.css("border-top-width")) + parseInt(l.css("border-bottom-width")), o.toggleClass("active-toggle"), o.hasClass("active-toggle") ? (l.css({
                        height: u
                    }), e.attr("aria-expanded", "true"), l.attr("aria-hidden", "false"), s.ajaxTemplate && h(c), r.trigger("jet-tabs/accordion/show-toggle-event/before", {
                        target: i,
                        toggleIndex: c
                    }), n && clearTimeout(n), n = setTimeout(function() {
                        r.trigger("jet-tabs/accordion/show-toggle-event/after", {
                        ...
                        height: l.outerHeight()
                    }), e.attr("aria-expanded", "false"), l.attr("aria-hidden", "true"), a && clearTimeout(a), a = setTimeout(function() {
                        l.css({
                            height: 0
                        })
                    }, 5))
        ...
        loadScriptAsync: function(t, e) {
            return o.addedScripts.hasOwnProperty(t) ? t : e ? (o.addedScripts[t] = e, new Promise(function(n, o) {
        ...
        loadStyle: function(t, e) {
            return o.addedStyles.hasOwnProperty(t) && o.addedStyles[t] === e ? t : e ? (o.addedStyles[t] = e, new Promise(function(n, o) {
                var a = document.createElement("link");
                a.id = t, a.rel = "stylesheet", a.href = e, a.type = "text/css", a.media = "all", a.onload = function() {
                    n(t)
                }, document.head.appendChild(a)
            })) : void 0
        },
    ...
    }, t(window).on("elementor/frontend/init", o.init), window.JetTabs = o
