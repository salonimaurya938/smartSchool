    ...
    [819], {
        ...
        8949: (e, t, n) => {
            ...
            L || (F = function Promise(e) {
                ...
                Promise: F
            }), n(2280)(F, _), n(4472)(_), a = n(7252).Promise, c(c.S + c.F * !L, _, {
        ...
        9320: (e, t, n) => {
            ...
            var o = i(n(4058)),
                ...
                s = i(n(2804)),
                l = i(n(3384)),
                d = [o.default, r.default, a.default, s.default, l.default];
            t.default = d
        },
        3384: (e, t, n) => {
            "use strict";
            ...
            e.exports = elementorModules.ViewModule.extend({
                ...
                getShareLinks: function getShareLinks() {
                    var e, t = this,
                        ...
                        s = this.getSlide("active"),
                        l = s.find(r.image),
                        d = s.data("elementor-slideshow-video");
                    return e = d || l.attr("src"), i.each(n, (function(n, o) {
                        var r = i("<a>", {
                        ...
                        href: e,
                        download: ""
                    }).text(wp.i18n.__("Download image", "elementor")).prepend(i("<i>", {
                ...
                getSlideshowHeader: function getSlideshowHeader() {
                    ...
                    var e = jQuery,
                        t = "yes" === elementorFrontend.getKitSettings("lightbox_enable_counter"),
                        n = "yes" === elementorFrontend.getKitSettings("lightbox_enable_fullscreen"),
                        i = "yes" === elementorFrontend.getKitSettings("lightbox_enable_zoom"),
                        o = "yes" === elementorFrontend.getKitSettings("lightbox_enable_share"),
                        r = this.getSettings("classes"),
                        a = r.slideshow,
                        s = this.elements;
                    if (t || n || i || o) {
                        if (s.$header = e("<header>", {
                                class: a.header + " " + r.preventClose
                            }), o) {
                            s.$iconShare = e("<i>", {
                                class: a.iconShare,
                                role: "button",
                            ...
                            l.on("click", (function(e) {
                                ...
                                class: a.shareMenu
                            }).append(l), s.$iconShare.add(s.$shareMenu).on("click", this.toggleShareMenu), s.$header.append(s.$iconShare, s.$shareMenu), this.$buttons = this.$buttons.add(s.$iconShare)
                        }
                        return i && (s.$iconZoom = e("<i>", {
                            class: a.iconZoomIn,
                            role: "switch",
                            "aria-checked": !1,
                            "aria-label": wp.i18n.__("Zoom", "elementor")
                        }), s.$iconZoom.on("click", this.toggleZoomMode), s.$header.append(s.$iconZoom), this.$buttons = this.$buttons.add(s.$iconZoom)), n && (s.$iconExpand = e("<i>", {
                            class: a.iconExpand,
                            role: "switch",
                            "aria-checked": !1,
                            "aria-label": wp.i18n.__("Fullscreen", "elementor")
                        }).append(e("<span>"), e("<span>")), s.$iconExpand.on("click", this.toggleFullscreen), s.$header.append(s.$iconExpand), this.$buttons = this.$buttons.add(s.$iconExpand)), t && (s.$counter = e("<span>", {
                            class: a.counter
                        }), s.$header.append(s.$counter)), s.$header
                    }
                },
                ...
                setSlideshowContent: function setSlideshowContent(e) {
                    var t, n, i = this,
                        a = (elementorFrontend.config.i18n, jQuery),
                        s = 1 === e.slides.length,
                        l = "" !== elementorFrontend.getKitSettings("lightbox_title_src"),
                        d = "" !== elementorFrontend.getKitSettings("lightbox_description_src"),
                        u = l || d,
                        ...
                        v = a("<div>", {
                            class: h.slidesWrapper
                        });
                    e.slides.forEach((function(e) {
                        var t = h.slide + " " + c.item;
                        e.video && (t += " " + c.video);
                        var n = a("<div>", {
                            class: t
                        });
                        if (e.video) {
                            ...
                            var o = a("<div>", {
                                ...
                                r = a('<div class="swiper-lazy-preloader"></div>'),
                                s = {
                                    "data-src": e.image,
                            ...
                            var l = a("<img>", s);
                            o.append([l, r]), n.append(o)
                        }
                        v.append(n)
                    })), this.elements.$container = f, this.elements.$header = this.getSlideshowHeader(), f.prepend(this.elements.$header).append(v), s || (t = a("<div>", {
                        class: h.prevButton + " " + c.preventClose,
                        "aria-label": wp.i18n.__("Previous", "elementor")
                    }).html(a("<i>", {
                        class: h.prevButtonIcon
                    })), n = a("<div>", {
                        class: h.nextButton + " " + c.preventClose,
                        "aria-label": wp.i18n.__("Next", "elementor")
                    }).html(a("<i>", {
                        class: h.nextButtonIcon
                    ...
                    g.setMessage(f);
                    var p = g.onShow;
                    g.onShow = (0, r.default)(o.default.mark((function _callee() {
                        var r, l;
                            ...
                            for (;;) switch (o.prev = o.next) {
                                case 0:
                                    return p(), r = {
                                        ...
                                        prevEl: t,
                                        nextEl: n
                                    }), e.swiper && a.extend(r, e.swiper), l = elementorFrontend.utils.swiper, o.next = 7, new l(f, r);
                                case 7:
                                    i.swiper = o.sent, f.data("swiper", i.swiper), i.setVideoAspectRatio(), i.playSlideVideo(), u && i.updateFooterText(), i.bindHotKeys(), i.makeButtonsAccessible();
                                case 14:
                                case "end":
                                    return o.stop()
                            }
                ...
                playSlideVideo: function playSlideVideo() {
                    ...
                    if (n) {
                        var i, o, r = this.getSettings("classes"),
                            a = jQuery("<div>", {
                                class: r.videoContainer + " " + r.invisible
                            }),
                            s = jQuery("<div>", {
                                class: r.videoWrapper
                            }),
