															...
															<div class="woocommerce">
																...
																<div class="col-md-6 offset-md-3" id="formid">
																	<div class="my-card mt-5 radius">
																		<div class="container">
																			<img src="assets/img/key.png" class="key" height="50px" width="50px" alt="Not Found Path" />
																		</div>
																		<h3 class="text-center">ScholarShips
																			Login here...</h3>
																		<h1 th:text="${errormsg}"></h1>
																		<form action="db/scholarlogin.php" method="post" class="formId">
																			<div class="form-group">
																				<label for="email">Username</label>
																				<input type="text" required name="username" class="form-control" id="userId" aria-describedby="emailHelp" placeholder="Enter Your UserId...">
																			</div>
																			<div class="form-group">
